...
insert into client (client_id, client_secret, redirect_uri, data_criacao, data_atualizacao)
values ('react', '{bcrypt}$2a$10$SLxHb1QOYY1d3eIhwHJiu.5JSrShejvkNIlG2CIeWeS8LtG6eQBwq', 'http://localhost:5173/callback', '2026-05-26 10:43:41.848', '2026-05-26 10:43:41.848');
-- senha: client123