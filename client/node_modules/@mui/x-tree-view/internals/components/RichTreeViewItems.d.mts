...
import type { TreeItemProps } from "../../TreeItem/index.mjs";
...
export declare const RichTreeViewItem: React.MemoExoticComponent<({
  ...
  itemId,
  skipChildren
}: RichTreeViewItemProps) => React.JSX.Element>;
export declare function RichTreeViewItems<TProps extends object>(props: RichTreeViewItemsProps<TProps>): React.JSX.Element;
