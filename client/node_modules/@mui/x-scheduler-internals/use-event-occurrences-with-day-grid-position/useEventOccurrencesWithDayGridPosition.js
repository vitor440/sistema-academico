...
exports.useEventOccurrencesWithDayGridPosition = useEventOccurrencesWithDayGridPosition;
...
function useEventOccurrencesWithDayGridPosition(parameters) {
  ...
  return React.useMemo(() => {
    ...
    const processedDays = days.map((day, dayIndex) => {
      ...
      const baseSorted = (0, _sortEventOccurrences.sortEventOccurrences)(needsPosition);
      const sortedNeedsPosition = maxEvents == null ? baseSorted : baseSorted.sort((a, b) => {
        ...
        const bSpan = adapter.differenceInDays(b.displayTimezone.end.value, b.displayTimezone.start.value);
        return bSpan - aSpan;
      });
      ...
      for (const occurrence of sortedNeedsPosition) {
        ...
        withPosition.push((0, _extends2.default)({}, occurrence, {
          position
        }));
      }
      ...
      return (0, _extends2.default)({}, day, {
        withPosition,
        withoutPosition
      });
    });
