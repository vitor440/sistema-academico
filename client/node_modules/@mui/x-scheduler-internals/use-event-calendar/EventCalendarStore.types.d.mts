import type { EventCalendarPreferences, CalendarView, EventCalendarPreferencesMenuConfig, EventCalendarViewConfig, EventCalendarViewDefinition } from "../models/index.mjs";
import type { SchedulerState, SchedulerParameters, SchedulerChangeEventDetails } from "../internals/utils/SchedulerStore/index.mjs";
 ...
 */
export type CollapsibleResourcesParameterKeys = 'collapsedResources' | 'defaultCollapsedResources' | 'onCollapsedResourcesChange';
