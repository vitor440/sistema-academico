...
export interface SchedulerParameters<TEvent extends object, TResource extends object> {
   ...
   */
  onCollapsedResourcesChange?: (collapsedResources: Record<SchedulerResourceId, boolean>, eventDetails: SchedulerChangeEventDetails) => void;
  /**
