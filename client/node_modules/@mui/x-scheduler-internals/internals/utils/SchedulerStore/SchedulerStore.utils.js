...
exports.getCustomEventProperties = getCustomEventProperties;
...
function getCustomEventProperties(model) {
  ...
  for (const key in model) {
    if (model.hasOwnProperty(key) && !EVENT_PROPERTIES_LOOKUP.hasOwnProperty(key)) {
      customProperties[key] = model[key];
    }
  }
