...
import { createDayTimeGridViewDefinition } from "../internals/utils/day-time-grid-view-definition.mjs";
 ...
 */
export const WeekView = /*#__PURE__*/React.memo(/*#__PURE__*/React.forwardRef(function WeekView(props, forwardedRef) {
  // Context hooks
  ...
  const {
    days
  } = useEventCalendarView(WEEK_VIEW_DEFINITION);

  // Selector hooks
  const config = useStore(store, eventCalendarViewSelectors.timeGridConfig, 'week');
  return /*#__PURE__*/_jsx(DayTimeGrid, _extends({
    ref: forwardedRef,
    days: days,
