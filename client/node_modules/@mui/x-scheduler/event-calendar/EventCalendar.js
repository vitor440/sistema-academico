...
var _SharedComponentsStyledContext = require("../internals/components/SharedComponentsStyledContext");
var _eventCalendarClasses = require("./eventCalendarClasses");
var _EventCalendarStyledContext = require("./EventCalendarStyledContext");
var _EventDialogStyledContext = require("../internals/components/event-dialog/EventDialogStyledContext");
var _defaultLocaleText = require("../internals/constants/defaultLocaleText");
var _EventCalendarRoot = require("./EventCalendarRoot");
var _jsxRuntime = require("react/jsx-runtime");
const _excluded = ["className", "classes"],
  _excluded2 = ["localeText", "apiRef"];
const EventCalendar = exports.EventCalendar = /*#__PURE__*/React.forwardRef(function EventCalendar(inProps, forwardedRef) {
  const props = (0, _styles.useThemeProps)({
    props: inProps,
    name: 'MuiEventCalendar'
  });
  const _useExtractEventCalen = (0, _useEventCalendar.useExtractEventCalendarParameters)(props),
    {
      parameters,
      forwardedProps: {
        className,
    ...
    forwardedProps = (0, _objectWithoutPropertiesLoose2.default)(_useExtractEventCalen.forwardedProps, _excluded);
  const store = (0, _useEventCalendar.useEventCalendar)(parameters);
  const classes = (0, _eventCalendarClasses.useEventCalendarUtilityClasses)(classesProp);
  const {
      localeText,
      apiRef
    } = forwardedProps,
    other = (0, _objectWithoutPropertiesLoose2.default)(forwardedProps, _excluded2);
  (0, _internals.useInitializeApiRef)(store, apiRef);
  const schedulerId = (0, _useId.useId)();
  const mergedLocaleText = React.useMemo(() => (0, _extends2.default)({}, _defaultLocaleText.EVENT_CALENDAR_DEFAULT_LOCALE_TEXT, localeText), [localeText]);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_useSchedulerStoreContext.SchedulerStoreContext.Provider, {
    value: store,
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_EventCalendarStyledContext.EventCalendarStyledContext.Provider, {
      value: calendarStyledContextValue,
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_EventDialogStyledContext.EventDialogStyledContext.Provider, {
        value: dialogStyledContextValue,
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_SharedComponentsStyledContext.SharedComponentsStyledContext.Provider, {
          value: sharedComponentsStyledContextValue,
          children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_eventDialog.EventDialogProvider, {
            children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_EventCalendarRoot.EventCalendarRoot, (0, _extends2.default)({
              className: className
            }, other, {
              ref: forwardedRef
            }))
...
process.env.NODE_ENV !== "production" ? EventCalendar.propTypes /* remove-proptypes */ = {
  ...
  apiRef: _propTypes.default.shape({
    current: _propTypes.default.shape({
      setVisibleDate: _propTypes.default.func
    })
  }),
  /**
   ...
   */
  collapsedResources: _propTypes.default.object,
  /**
   ...
   */
  defaultCollapsedResources: _propTypes.default.object,
  /**
   ...
   */
  onCollapsedResourcesChange: _propTypes.default.func,
  /**
   ...
   */
  viewConfig: _propTypes.default.shape({
