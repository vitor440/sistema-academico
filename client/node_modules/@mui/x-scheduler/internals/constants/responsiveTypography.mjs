...
export const eventCalendarRootCompactQuery = containerWidthBelow(EVENT_CALENDAR_ROOT_CONTAINER_NAME, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM);
export const eventCalendarRootExpandedQuery = containerWidthFrom(EVENT_CALENDAR_ROOT_CONTAINER_NAME, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM);
...
export const eventCalendarContentCompactQuery = containerWidthBelow(EVENT_CALENDAR_CONTAINER_NAME, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM);
