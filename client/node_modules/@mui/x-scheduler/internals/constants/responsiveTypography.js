...
exports.responsiveTypographyTokens = exports.responsiveTypographyContainerQueries = exports.responsiveTokens = exports.eventCalendarRootExpandedQuery = exports.eventCalendarRootCompactQuery = exports.eventCalendarContentCompactQuery = exports.RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM = exports.RESPONSIVE_TYPOGRAPHY_BREAKPOINT_MD = exports.EVENT_CALENDAR_ROOT_CONTAINER_NAME = exports.EVENT_CALENDAR_CONTAINER_NAME = void 0;
...
const EVENT_CALENDAR_ROOT_CONTAINER_NAME = exports.EVENT_CALENDAR_ROOT_CONTAINER_NAME = 'mui-event-calendar-root';
...
const containerWidthBelow = (containerName, widthPx) => `@container ${containerName} (width < ${widthPx}px)`;
const containerWidthFrom = (containerName, widthPx) => `@container ${containerName} (width >= ${widthPx}px)`;
const containerWidthBetween = (containerName, minWidthPx, maxWidthPx) => `@container ${containerName} (${minWidthPx}px <= width < ${maxWidthPx}px)`;
...
const eventCalendarRootCompactQuery = exports.eventCalendarRootCompactQuery = containerWidthBelow(EVENT_CALENDAR_ROOT_CONTAINER_NAME, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM);
const eventCalendarRootExpandedQuery = exports.eventCalendarRootExpandedQuery = containerWidthFrom(EVENT_CALENDAR_ROOT_CONTAINER_NAME, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM);
...
const eventCalendarContentCompactQuery = exports.eventCalendarContentCompactQuery = containerWidthBelow(EVENT_CALENDAR_CONTAINER_NAME, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM);
...
const responsiveTypographyContainerQueries = exports.responsiveTypographyContainerQueries = {
  ...
  [containerWidthBetween(EVENT_CALENDAR_CONTAINER_NAME, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_SM, RESPONSIVE_TYPOGRAPHY_BREAKPOINT_MD)]: {
