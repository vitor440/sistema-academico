...
import { getTimeGridHourRange } from "../../utils/getTimeGridHourRange.mjs";
...
import { eventCalendarContentCompactQuery } from "../../constants/responsiveTypography.mjs";
...
export const DayTimeGrid = /*#__PURE__*/React.forwardRef(function DayTimeGrid(props, forwardedRef) {
  ...
  const {
    startTime,
    endTime
  } = getTimeGridHourRange(startTimeProp, endTimeProp);
        ...
        children: /*#__PURE__*/_jsxs(DayTimeGridScrollableContent, {
          ...
          children: [/*#__PURE__*/_jsx(DayTimeGridTimeAxis, {
            ...
            children: Array.from({
              ...
              return /*#__PURE__*/_jsx(DayTimeGridTimeAxisCell, {
