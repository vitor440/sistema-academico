...
import { MonthViewCell } from "./MonthViewCell.mjs";
...
export default function MonthViewWeekRow(props) {
  const {
    rowIndex,
    maxEvents,
    days,
