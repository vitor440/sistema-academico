...
const faIRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, formattedTime) => `انتخاب ${views[view]}. ${!formattedTime ? 'زمانی انتخاب نشده است' : `زمان انتخاب شده ${formattedTime} است`}`,
  ...
  // Open Picker labels
  openDatePickerDialogue: formattedDate => formattedDate ? `تاریخ را انتخاب کنید، تاریخ انتخاب شده ${formattedDate} است` : 'تاریخ را انتخاب کنید',
  openTimePickerDialogue: formattedTime => formattedTime ? `زمان را انتخاب کنید، زمان انتخاب شده ${formattedTime} است` : 'زمان را انتخاب کنید',
  openRangePickerDialogue: formattedRange => formattedRange ? `بازه را انتخاب کنید، بازه زمانی انتخاب شده ${formattedRange} است` : 'بازه را انتخاب کنید',
