...
import type { InferNonNullablePickerValue, PickerRangeValue, PickerValidValue } from "./value.mjs";
...
type PickerManagerProperties<TManager extends PickerAnyManager> = TManager extends PickerManager<infer TValue, infer TError, infer TValidationProps, infer TFieldInternalProps> ? {
  value: TValue;
  error: TError;
...
export type PickerManagerFieldInternalPropsWithDefaults<TManager extends PickerAnyManager> = UseFieldInternalProps<PickerManagerValue<TManager>, PickerManagerError<TManager>> & PickerManagerValidationProps<TManager>;
