...
const MultiSectionDigitalClock = exports.MultiSectionDigitalClock = /*#__PURE__*/React.forwardRef(function MultiSectionDigitalClock(inProps, ref) {
  ...
  const buildViewProps = React.useCallback(viewToBuild => {
    switch (viewToBuild) {
      ...
      default:
        throw new Error(process.env.NODE_ENV !== "production" ? `MUI X Date Pickers: Unknown view "${viewToBuild}" found in MultiSectionDigitalClock. ` + 'This view is not supported by the component. ' + 'Use valid view values: "hours", "minutes", "seconds", or "meridiem".' : (0, _formatErrorMessage2.default)(144, viewToBuild));
    }
...
process.env.NODE_ENV !== "production" ? MultiSectionDigitalClock.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
