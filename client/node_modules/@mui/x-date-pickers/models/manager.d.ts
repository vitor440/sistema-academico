 ...
 * ```
 */
export interface PickerManager<TValue extends PickerValidValue, TError, TValidationProps extends {}, TFieldInternalProps extends {}> {
  /**
   ...
   */
  internal_useApplyDefaultValuesToFieldInternalProps: (internalProps: TFieldInternalProps) => UseFieldInternalProps<TValue, TError> & TValidationProps;
  /**
