...
import type { BaseSingleInputFieldProps, FieldRangeSection, PickerRangeValue, PickerValidValue } from "../internals/models/index.mjs";
import type { PickerOwnerState } from "./pickers.mjs";
 ...
 */
export type PickerFieldSlotProps<TValue extends PickerValidValue> = ExportedPickerFieldUIProps & Pick<UseFieldInternalProps<TValue, unknown>, 'shouldRespectLeadingZeros' | 'readOnly' | 'fieldRef'> & React.HTMLAttributes<HTMLDivElement> & {
 ...
 */
export type BaseSingleInputPickersTextFieldProps = Omit<UseFieldReturnValue<BaseSingleInputFieldProps>, 'slots' | 'slotProps' | 'clearable' | 'onClear' | 'openPickerButtonPosition' | 'clearButtonPosition' | 'openPickerAriaLabel'>;
/**
