...
function Clock(inProps) {
  ...
  const squareMaskRef = React.useRef(null);
  const removeDragListenersRef = React.useRef(undefined);
  ...
  const handleDocumentPointerMove = (0, _useEventCallback.default)(event => {
  ...
  const handleDocumentPointerUp = (0, _useEventCallback.default)(event => {
    if (event.pointerId !== activePointerIdRef.current) {
      return;
    }
    stopTracking();
  ...
  const handleDocumentPointerCancel = (0, _useEventCallback.default)(event => {
    if (event.pointerId !== activePointerIdRef.current) {
      return;
    }
  ...
  const handlePointerDown = event => {
    ...
    const doc = (0, _ownerDocument.default)(squareMaskRef.current);
