...
const TimeClock = exports.TimeClock = /*#__PURE__*/React.forwardRef(function TimeClock(inProps, ref) {
  ...
  const viewProps = React.useMemo(() => {
    switch (view) {
      ...
      default:
        throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: You must provide the type for ClockView' : (0, _formatErrorMessage2.default)(147));
    }
...
process.env.NODE_ENV !== "production" ? TimeClock.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
